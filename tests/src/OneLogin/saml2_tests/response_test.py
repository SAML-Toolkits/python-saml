...
class OneLogin_Saml2_Response_Test(unittest.TestCase):
    ...
    def testConstruct(self):
        """
        Tests the OneLogin_Saml2_Response_Post Constructor.
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)

        self.assertIsInstance(response, OneLogin_Saml2_Response_Post)

        xml_enc = self.file_contents(join(self.data_path, 'responses', 'valid_encrypted_assertion.xml.base64'))
        response_enc = OneLogin_Saml2_Response_Post(settings, xml_enc)

        self.assertIsInstance(response_enc, OneLogin_Saml2_Response_Post)

    def testReturnNameId(self):
        """
        Tests the get_nameid method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
        ...
        response_2 = OneLogin_Saml2_Response_Post(settings, xml_2)
        ...
        response_3 = OneLogin_Saml2_Response_Post(settings, xml_3)
        ...
        response_4 = OneLogin_Saml2_Response_Post(settings, xml_4)
        try:
    ...
    def testGetNameIdData(self):
        """
        Tests the get_nameid_data method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
    ...
    def testCheckStatus(self):
        """
        Tests the check_status method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
    ...
    def testGetAudiences(self):
        """
        Tests the get_audiences method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
    ...
    def testQueryAssertions(self):
        ...
        OneLogin_Saml2_Response_Post using the get_issuers call
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
        ...
        response_5 = OneLogin_Saml2_Response_Post(settings, xml_5)
        ...
        response_6 = OneLogin_Saml2_Response_Post(settings, xml_6)
        ...
        response_7 = OneLogin_Saml2_Response_Post(settings, xml_7)
        self.assertEqual(['http://idp.example.com/'], response_7.get_issuers())

    def testGetIssuers(self):
        """
        Tests the get_issuers method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
    ...
    def testGetSessionIndex(self):
        """
        Tests the get_session_index method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
    ...
    def testGetAttributes(self):
        """
        Tests the getAttributes method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
    ...
    def testGetSessionNotOnOrAfter(self):
        """
        Tests the get_session_not_on_or_after method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
    ...
    def testIsInvalidXML(self):
        """
        Tests the is_valid method of the OneLogin_Saml2_Response_Post
        Case Invalid XML
        """
    ...
    def testValidateNumAssertions(self):
        """
        Tests the validate_num_assertions method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
        xml = self.file_contents(join(self.data_path, 'responses', 'response1.xml.base64'))
        response = OneLogin_Saml2_Response_Post(settings, xml)
        ...
        response_2 = OneLogin_Saml2_Response_Post(settings, xml_multi_assertion)
        self.assertFalse(response_2.validate_num_assertions())

    def testValidateTimestamps(self):
        """
        Tests the validate_timestamps method of the OneLogin_Saml2_Response_Post
        """
        settings = OneLogin_Saml2_Settings(self.loadSettingsJSON())
    ...
    def testIsInValidExpired(self):
        ...
        settings.set_strict(True)
        response_2 = OneLogin_Saml2_Response_Post(settings, xml)
        try:
    ...
    def testIsInValidDestination(self):
        """
        Tests the is_valid method of the OneLogin_Saml2_Response_Post class
        ...
        response_3 = OneLogin_Saml2_Response_Post(settings, message_2)
        ...
        response_4 = OneLogin_Saml2_Response_Post(settings, message_3)
    ...
    def testIsInValidIssuer(self):
        ...
        response_2 = OneLogin_Saml2_Response_Post(settings, message_2)
        response_2.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_2.get_error())

        settings.set_strict(True)
        response_3 = OneLogin_Saml2_Response_Post(settings, message)
        try:
        ...
        response_4 = OneLogin_Saml2_Response_Post(settings, message_2)
        try:
    ...
    def testIsInValidSignIssues(self):
        ...
        response_2 = OneLogin_Saml2_Response_Post(settings_2, message)
        response_2.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_2.get_error())
        ...
        response_3 = OneLogin_Saml2_Response_Post(settings_3, message)
        response_3.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_3.get_error())

        settings_info['security']['wantAssertionsSigned'] = True
        settings_4 = OneLogin_Saml2_Settings(settings_info)
        response_4 = OneLogin_Saml2_Response_Post(settings_4, message)
        try:
            self.assertFalse(response_4.is_valid(request_data))
        except Exception as e:
        ...
        response_5 = OneLogin_Saml2_Response_Post(settings_5, message)
        response_5.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_5.get_error())

        settings_info['security']['wantMessagesSigned'] = True
        settings_6 = OneLogin_Saml2_Settings(settings_info)
        response_6 = OneLogin_Saml2_Response_Post(settings_6, message)
        response_6.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_6.get_error())
        ...
        response_8 = OneLogin_Saml2_Response_Post(settings_8, message)
        try:
    ...
    def testIsInValidEncIssues(self):
        ...
        settings_info['strict'] = False
        settings = OneLogin_Saml2_Settings(settings_info)
        response_4 = OneLogin_Saml2_Response_Post(settings, message)
        response_4.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_4.get_error())

        settings_info['strict'] = True
        settings = OneLogin_Saml2_Settings(settings_info)
        response_5 = OneLogin_Saml2_Response_Post(settings, message)
    ...
    def testIsValid2(self):
        ...
        response_2 = OneLogin_Saml2_Response_Post(settings_2, xml_2)
        ...
        response_3 = OneLogin_Saml2_Response_Post(settings_3, xml_2)
        ...
        response_4 = OneLogin_Saml2_Response_Post(settings_4, xml_2)
        ...
        response_5 = OneLogin_Saml2_Response_Post(settings_5, xml_2)
        ...
        response_6 = OneLogin_Saml2_Response_Post(settings_6, xml_2)
    ...
    def testIsValidEnc(self):
        ...
        response_4 = OneLogin_Saml2_Response_Post(settings_2, xml_4)
        self.assertTrue(response_4.is_valid(self.get_request_data()))

        xml_5 = self.file_contents(join(self.data_path, 'responses', 'signed_encrypted_assertion2.xml.base64'))
        response_5 = OneLogin_Saml2_Response_Post(settings_2, xml_5)
        ...
        response_6 = OneLogin_Saml2_Response_Post(settings_2, xml_6)
        self.assertTrue(response_6.is_valid(self.get_request_data()))
        ...
        plain_message = plain_message.replace('http://stuff.com/endpoints/endpoints/acs.php', current_url)
        message = b64encode(plain_message)
        response_7 = OneLogin_Saml2_Response_Post(settings, message)
        response_7.is_valid(request_data)
        self.assertEqual('No Signature found. SAML Response rejected', response_7.get_error())
    ...
    def testIsValidSign(self):
        ...
        response_8 = OneLogin_Saml2_Response_Post(settings, xml_8)
        # Modified message
        ...
        response_9 = OneLogin_Saml2_Response_Post(settings, xml_9)
        # Modified message
